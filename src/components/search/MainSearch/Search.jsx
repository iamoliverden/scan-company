...
import './Search.css';
import CompanyINN from '../SearchElements/CompanyINN';
import Tonality from '../SearchElements/Tonality';
import DocumentCount from '../SearchElements/DocumentCount';
import DateInput from '../SearchElements/DateInput';
import CheckboxBlock from '../SearchElements/CheckboxBlock';

import search_page_large_picture from "../../../assets/pics/search_page_large_picture.svg"
import search_page_small_picture_folders from "../../../assets/pics/search_page_small_picture_folders.svg"
import search_page_small_picture_sheet from "../../../assets/pics/search_page_small_picture_sheet.svg"
...
const Search = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (isFormValid) {
      ...
      console.log('Sending a request to the server with data:', searchParams);
  
      navigate('/results', { state: { searchParams: searchParams } });
    } else {
      console.log('The form is not valid, the redirection has not been completed.');
    }
  };
    ...
    <div className="search-content">
      ...
      <div className="search-title-block">
        <div className="search-title-text">
          <h1 className="h1-search-page">Find the necessary <br />data in a couple of clicks.</h1>
          <p className="p-search-page-title-block">Set your search parameters. <br />The more you fill in, the more accurate the search.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="search-form">
          ...
          <div className="right-part-search-form">
            ...
            <div className="right-part-submit-button-block">
              <button className="button" type="submit" disabled={!isFormValid}>Search</button>
              <p className="star-message">* Mandatory field</p>
            </div>
          </div>
