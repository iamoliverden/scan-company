...
import scan_logo_green from '../../assets/pics/scan_logo_green.svg';
import scan_logo_white from '../../assets/pics/scan_logo_white.svg';
import fallout_menu_icon from '../../assets/pics/fallout_menu_icon.svg';
import close_icon from '../../assets/pics/closing-icon.png';
                ...
                {!isLoggedIn && !isMobile && (
                    <div className="right-section">
                        <div className="reg-block">
                            <a href="/auth" className="reg-link login">Sign Up</a>
                            <div className="vertical-divider"></div>
                            <button className="login-button" id="loginButton" onClick={handleLoginClick}>Login</button>
                        </div>
                    </div>    
                )}
            </div>
            ...
            {isMenuVisible && isMobile && (
                <div className="dropdown-menu-page">
                    ...
                    {isLoggedIn ? (
                        ...
                        <div className="reg-block">
                            <a href="/auth" className="reg-link login">Sign Up</a>
                            <button className="login-button" id="loginButton" onClick={handleLoginAndCloseMenu}>Login</button>
                        </div>
                    )}  
                </div> 
            )} 
