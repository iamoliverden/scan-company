    ...
    useEffect(() => {
        const fetchCompanyInfo = async () => {
            ...
            try {
                ...
                console.error("Error when obtaining information about companies:", error);
            } finally {
                setIsLoading(false);
            }
        };
        ...
        <div className="user-actions-rectangle">
            {isLoading ? (
                ...
                <div className="user-actions-data">
                    <div className="action-item">Companies limit used</div>
                    <div className="number-item used-companies-number">{usedCompanyCount}</div>
                    <div className="action-item">Companies limit total</div>
