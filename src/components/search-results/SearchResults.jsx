...
import search_results_large_picture from '../../assets/pics/search_results_large_picture.svg';
  ...
  useEffect(() => {
    const fetchSearchResults = async () => {
      ...
      try {
        ...
        console.log("Count of Publications:", publicationIds.length);

        // Request for docs by ID
        ...
        if (!documentsResponse.ok) {
          ...
          console.log("number of received ID publications:", publicationIds.length);
        }
        ...
        <>
          <div className="search-results-title-block">
            <div className="search-results-title-text">
                <h1 className="h1-search-results-page">Searching. Results will be available soon</h1>
                <p className="p-search-results-page-title-block">The search may take some time, please be patient.</p>
            </div>
